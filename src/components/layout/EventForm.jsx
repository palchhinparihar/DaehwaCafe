    ...
    <form onSubmit={onSubmit} className="space-y-8">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-1 flex items-center gap-2 text-2xl font-bold text-stone-950">
              <FiImage className="text-violet-600" aria-hidden="true" />
              Event images
            </h2>
            ...
            {imagePreviews.map((preview, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="absolute cursor-pointer right-2.5 top-2.5 inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/60 bg-stone-950/75 text-white shadow-lg shadow-stone-950/20 backdrop-blur-md transition duration-200 hover:-translate-y-0.5 hover:bg-rose-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-stone-900"
                >
                  <span className="sr-only">Remove image</span>
                  <FiX size="20" className="text-base" aria-hidden="true" />
                </button>
              </div>
            ))}
          </div>
      ...
      <section className="rounded-[1.5rem] border border-indigo-100 bg-indigo-50/45 p-5 sm:p-6">
        <div>
          ...
          <h2 className="mt-1 flex items-center gap-2 text-2xl font-bold text-stone-950">
            <FiVideo className="text-indigo-600" aria-hidden="true" />
            Event video
          </h2>
          <p className="mt-2 text-sm leading-6 text-stone-600">
        ...
        <input
          ...
          className="mt-5 block w-full cursor-pointer rounded-2xl border border-dashed border-indigo-300 bg-white/80 p-3 text-sm text-stone-600 file:mr-4 file:cursor-pointer file:rounded-xl file:border-0 file:bg-indigo-700 file:px-4 file:py-2.5 file:text-sm file:font-bold file:text-white hover:border-indigo-500 file:hover:bg-indigo-800"
        />
      ...
      <div className="flex flex-col-reverse gap-3 border-t border-violet-100 pt-6 sm:flex-row sm:items-center sm:justify-between">
        <p className="flex items-center gap-2 text-xs font-medium text-stone-500">
          <FiUploadCloud className="text-violet-600" aria-hidden="true" />
        ...
        <button
          ...
          onClick={onCancel}
          disabled={loading}
          className="rounded-full cursor-pointer border border-violet-200 bg-white px-5 py-2.5 text-sm font-bold text-stone-700 transition hover:border-violet-300 hover:bg-violet-50 disabled:cursor-not-allowed disabled:opacity-50"
        >
          Cancel
        </button>
